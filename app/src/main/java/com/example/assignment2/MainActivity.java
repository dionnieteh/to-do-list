...
public class MainActivity extends AppCompatActivity {
    /*
    1. store to do list items in the array list rather than array
    because we dont know how many task list item the user will add
    2. use array adapter as a middlemen to connect the arraylist with listview
    ...
    */
    ...
    public void addNew(View view){
        Intent intent = new Intent(getApplicationContext(),
                note_editor.class); // open and link and page
        startActivity(intent);
    }

    // create menu bar for the app
    ...
    /*
    when user select add note at menu,
    create an explicit intent object to
    bring the user to another page or activity
    */
    public boolean onOptionsItemSelected(MenuItem item) {
        super.onOptionsItemSelected(item);
        if (item.getItemId() == R.id.add_note) { // if user chooses add note
            Intent intent = new Intent(getApplicationContext(),
                    note_editor.class); // open and link to note_editor class
            startActivity(intent);
            return true; // the user selects add menu item
        }
        else if (item.getItemId() == R.id.about_us){ // if user chooses about us
            Intent intent = new Intent(getApplicationContext(),
                    about_us.class); // open and link to about_us page
            startActivity(intent);
            return true; // the user selects about us item
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // for private use only, the SP aka file can be accessed by this app only
        ...
        /*
        1. shared preferences object cannot work directly with the arraylist
        2. this app will stored all the user input into array list first
        then convert the arraylist into hash set before we can save the user input into SP
        3. user input --> array list --> hash set --> shared preferences
        4. array list cannot --> shared preferences, need hash set as middlemen
        */
        ...
        // notes array list --> array adapter --> list v
